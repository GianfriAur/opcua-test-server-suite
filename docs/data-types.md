...
- Int64/UInt64 use array encoding `[high, low]` internally
...
|---|---|---|---|---|
| `Matrix2D_Double` | Double | 3x3 | RW | `[[1,2,3],[4,5,6],[7,8,9]]` stored as flat `Float64Array` |
| `Matrix2D_Int32` | Int32 | 2x4 | RW | `[[1,2,3,4],[5,6,7,8]]` stored as flat `Int32Array` |
| `Cube3D_Byte` | Byte | 2x3x4 | RW | Values `0..23` stored as flat `Uint8Array` |
