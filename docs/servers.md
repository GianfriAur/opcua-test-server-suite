...
| 8 | `opcua-legacy-security` | 4847 | Basic128Rsa15, Basic256 | Sign, SignAndEncrypt | Anonymous + Username |
...
Like `opcua-userpass` but automatically accepts any client certificate, even unknown ones.
...
## 8. Legacy Security (`opcua-legacy-security` — port 4847)
